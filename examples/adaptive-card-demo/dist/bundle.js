(function (require$$5) {
	...
	(function (exports) {
		...
		})(exports.InputValidationNecessity || (exports.InputValidationNecessity = {}));
		/*
	...
	function generateUniqueId() {
	    return "__ac-" + Shared$2.UUID.generate();
	}
	...
	utils.getStringValue = getStringValue;
	function getValueOrDefault(obj, defaultValue) {
	    return obj ? obj : defaultValue;
	}
	utils.getValueOrDefault = getValueOrDefault;
	...
	utils.setEnumProperty = setEnumProperty;
	...
	utils.getBoolValue = getBoolValue;
	...
	utils.getEnumValue = getEnumValue;
	...
	utils.parseHostConfigEnum = parseHostConfigEnum;
	function renderSeparation(hostConfig, separationDefinition, orientation) {
	    if (separationDefinition.spacing > 0 || separationDefinition.lineThickness > 0) {
	        var separator = document.createElement("div");
	        separator.className = hostConfig.makeCssClassName("ac-" + (orientation == Enums$2.Orientation.Horizontal ? "horizontal" : "vertical") + "-separator");
	        if (orientation == Enums$2.Orientation.Horizontal) {
	...
	utils.renderSeparation = renderSeparation;
	...
	utils.stringToCssColor = stringToCssColor;
	...
	function getFitStatus(element, containerEnd) {
	    ...
	    if (end <= containerEnd) {
	        return Enums$2.ContainerFitStatus.FullyInContainer;
	    }
	    else if (start < containerEnd) {
	        return Enums$2.ContainerFitStatus.Overflowing;
	    }
	    else {
	        return Enums$2.ContainerFitStatus.FullyOutOfContainer;
	    }
	}
	utils.getFitStatus = getFitStatus;
	...
	Object.defineProperty(hostConfig, "__esModule", { value: true });
	// Copyright (c) Microsoft Corporation. All rights reserved.
	// Licensed under the MIT License.
	var Enums$1 = enums;
	var Utils$1 = utils;
	...
	hostConfig.ColorDefinition = ColorDefinition;
	var TextColorDefinition = /** @class */ (function (_super) {
	    __extends$2(TextColorDefinition, _super);
	...
	hostConfig.TextColorDefinition = TextColorDefinition;
	...
	hostConfig.AdaptiveCardConfig = AdaptiveCardConfig;
	var ImageSetConfig = /** @class */ (function () {
	    function ImageSetConfig(obj) {
	        this.imageSize = Enums$1.Size.Medium;
	        this.maxImageHeight = 100;
	        if (obj) {
	            this.imageSize = obj["imageSize"] != null ? obj["imageSize"] : this.imageSize;
	            this.maxImageHeight = Utils$1.getValueOrDefault(obj["maxImageHeight"], 100);
	        }
	    }
	    ImageSetConfig.prototype.toJSON = function () {
	        return {
	            imageSize: Enums$1.Size[this.imageSize],
	            maxImageHeight: this.maxImageHeight
	        };
	    };
	    return ImageSetConfig;
	}());
	hostConfig.ImageSetConfig = ImageSetConfig;
	...
	hostConfig.MediaConfig = MediaConfig;
	var FactTextDefinition = /** @class */ (function () {
	    function FactTextDefinition(obj) {
	        this.size = Enums$1.TextSize.Default;
	        this.color = Enums$1.TextColor.Default;
	        this.isSubtle = false;
	        this.weight = Enums$1.TextWeight.Default;
	        this.wrap = true;
	        if (obj) {
	            this.size = Utils$1.parseHostConfigEnum(Enums$1.TextSize, obj["size"], Enums$1.TextSize.Default);
	            this.color = Utils$1.parseHostConfigEnum(Enums$1.TextColor, obj["color"], Enums$1.TextColor.Default);
	            this.isSubtle = obj["isSubtle"] || this.isSubtle;
	            this.weight = Utils$1.parseHostConfigEnum(Enums$1.TextWeight, obj["weight"], this.getDefaultWeight());
	            this.wrap = obj["wrap"] != null ? obj["wrap"] : this.wrap;
	        }
	    }
	    FactTextDefinition.prototype.getDefaultWeight = function () {
	        return Enums$1.TextWeight.Default;
	    };
	    FactTextDefinition.prototype.toJSON = function () {
	        return {
	            size: Enums$1.TextSize[this.size],
	            color: Enums$1.TextColor[this.color],
	            isSubtle: this.isSubtle,
	            weight: Enums$1.TextWeight[this.weight],
	            wrap: this.wrap
	        };
	    };
	    return FactTextDefinition;
	}());
	hostConfig.FactTextDefinition = FactTextDefinition;
	var FactTitleDefinition = /** @class */ (function (_super) {
	    __extends$2(FactTitleDefinition, _super);
	    function FactTitleDefinition(obj) {
	        var _this = _super.call(this, obj) || this;
	        _this.maxWidth = 150;
	        _this.weight = Enums$1.TextWeight.Bolder;
	        if (obj) {
	            _this.maxWidth = obj["maxWidth"] != null ? obj["maxWidth"] : _this.maxWidth;
	            _this.weight = Utils$1.parseHostConfigEnum(Enums$1.TextWeight, obj["weight"], Enums$1.TextWeight.Bolder);
	        }
	        return _this;
	    }
	    FactTitleDefinition.prototype.getDefaultWeight = function () {
	        return Enums$1.TextWeight.Bolder;
	    };
	    return FactTitleDefinition;
	}(FactTextDefinition));
	hostConfig.FactTitleDefinition = FactTitleDefinition;
	...
	hostConfig.FactSetConfig = FactSetConfig;
	var ShowCardActionConfig = /** @class */ (function () {
	    function ShowCardActionConfig(obj) {
	        this.actionMode = Enums$1.ShowCardActionMode.Inline;
	        this.inlineTopMargin = 16;
	        this.style = Enums$1.ContainerStyle.Emphasis;
	        if (obj) {
	            this.actionMode = Utils$1.parseHostConfigEnum(Enums$1.ShowCardActionMode, obj["actionMode"], Enums$1.ShowCardActionMode.Inline);
	            this.inlineTopMargin = obj["inlineTopMargin"] != null ? obj["inlineTopMargin"] : this.inlineTopMargin;
	            this.style = obj["style"] && typeof obj["style"] === "string" ? obj["style"] : Enums$1.ContainerStyle.Emphasis;
	        }
	    }
	    ShowCardActionConfig.prototype.toJSON = function () {
	        return {
	            actionMode: Enums$1.ShowCardActionMode[this.actionMode],
	...
	hostConfig.ShowCardActionConfig = ShowCardActionConfig;
	var ActionsConfig = /** @class */ (function () {
	    function ActionsConfig(obj) {
	        this.maxActions = 5;
	        this.spacing = Enums$1.Spacing.Default;
	        this.buttonSpacing = 20;
	        this.showCard = new ShowCardActionConfig();
	        this.preExpandSingleShowCardAction = false;
	        this.actionsOrientation = Enums$1.Orientation.Horizontal;
	        this.actionAlignment = Enums$1.ActionAlignment.Left;
	        this.iconPlacement = Enums$1.ActionIconPlacement.LeftOfTitle;
	        this.allowTitleToWrap = false;
	        this.iconSize = 24;
	        if (obj) {
	            this.maxActions = obj["maxActions"] != null ? obj["maxActions"] : this.maxActions;
	            this.spacing = Utils$1.parseHostConfigEnum(Enums$1.Spacing, obj.spacing && obj.spacing, Enums$1.Spacing.Default);
	            this.buttonSpacing = obj["buttonSpacing"] != null ? obj["buttonSpacing"] : this.buttonSpacing;
	            this.showCard = new ShowCardActionConfig(obj["showCard"]);
	            this.preExpandSingleShowCardAction = Utils$1.getValueOrDefault(obj["preExpandSingleShowCardAction"], false);
	            this.actionsOrientation = Utils$1.parseHostConfigEnum(Enums$1.Orientation, obj["actionsOrientation"], Enums$1.Orientation.Horizontal);
	            this.actionAlignment = Utils$1.parseHostConfigEnum(Enums$1.ActionAlignment, obj["actionAlignment"], Enums$1.ActionAlignment.Left);
	            this.iconPlacement = Utils$1.parseHostConfigEnum(Enums$1.ActionIconPlacement, obj["iconPlacement"], Enums$1.ActionIconPlacement.LeftOfTitle);
	            this.allowTitleToWrap = obj["allowTitleToWrap"] != null ? obj["allowTitleToWrap"] : this.allowTitleToWrap;
	            try {
	                var sizeAndUnit = Shared$1.SizeAndUnit.parse(obj["iconSize"]);
	                if (sizeAndUnit.unit == Enums$1.SizeUnit.Pixel) {
	    ...
	    ActionsConfig.prototype.toJSON = function () {
	        return {
	            ...
	            spacing: Enums$1.Spacing[this.spacing],
	            buttonSpacing: this.buttonSpacing,
	            showCard: this.showCard,
	            preExpandSingleShowCardAction: this.preExpandSingleShowCardAction,
	            actionsOrientation: Enums$1.Orientation[this.actionsOrientation],
	            actionAlignment: Enums$1.ActionAlignment[this.actionAlignment]
	        };
	    };
	    return ActionsConfig;
	}());
	hostConfig.ActionsConfig = ActionsConfig;
	...
	hostConfig.ColorSetDefinition = ColorSetDefinition;
	...
	hostConfig.ContainerStyleDefinition = ContainerStyleDefinition;
	var BuiltInContainerStyleDefinition = /** @class */ (function (_super) {
	    __extends$2(BuiltInContainerStyleDefinition, _super);
	...
	var ContainerStyleSet = /** @class */ (function () {
	    function ContainerStyleSet(obj) {
	        this._allStyles = {};
	        this._allStyles[Enums$1.ContainerStyle.Default] = new BuiltInContainerStyleDefinition();
	        this._allStyles[Enums$1.ContainerStyle.Emphasis] = new BuiltInContainerStyleDefinition();
	        this._allStyles[Enums$1.ContainerStyle.Accent] = new BuiltInContainerStyleDefinition();
	        this._allStyles[Enums$1.ContainerStyle.Good] = new BuiltInContainerStyleDefinition();
	        this._allStyles[Enums$1.ContainerStyle.Attention] = new BuiltInContainerStyleDefinition();
	        this._allStyles[Enums$1.ContainerStyle.Warning] = new BuiltInContainerStyleDefinition();
	        if (obj) {
	            this._allStyles[Enums$1.ContainerStyle.Default].parse(obj[Enums$1.ContainerStyle.Default]);
	            this._allStyles[Enums$1.ContainerStyle.Emphasis].parse(obj[Enums$1.ContainerStyle.Emphasis]);
	            this._allStyles[Enums$1.ContainerStyle.Accent].parse(obj[Enums$1.ContainerStyle.Accent]);
	            this._allStyles[Enums$1.ContainerStyle.Good].parse(obj[Enums$1.ContainerStyle.Good]);
	            this._allStyles[Enums$1.ContainerStyle.Attention].parse(obj[Enums$1.ContainerStyle.Attention]);
	            this._allStyles[Enums$1.ContainerStyle.Warning].parse(obj[Enums$1.ContainerStyle.Warning]);
	    ...
	    Object.defineProperty(ContainerStyleSet.prototype, "default", {
	        get: function () {
	            return this._allStyles[Enums$1.ContainerStyle.Default];
	        },
	        enumerable: true,
	        configurable: true
	    });
	    Object.defineProperty(ContainerStyleSet.prototype, "emphasis", {
	        get: function () {
	            return this._allStyles[Enums$1.ContainerStyle.Emphasis];
	        },
	        enumerable: true,
	        configurable: true
	    });
	...
	hostConfig.ContainerStyleSet = ContainerStyleSet;
	var Version = /** @class */ (function () {
	    ...
	    Version.parse = function (versionString, errors) {
	        ...
	        if (!result._isValid && errors) {
	            errors.push({
	                error: Enums$1.ValidationError.InvalidPropertyValue,
	...
	hostConfig.HostCapabilities = HostCapabilities;
	...
	hostConfig.FontTypeDefinition = FontTypeDefinition;
	var FontTypeSet = /** @class */ (function () {
	    ...
	    FontTypeSet.prototype.getStyleDefinition = function (style) {
	        switch (style) {
	            case Enums$1.FontType.Monospace:
	                return this.monospace;
	            case Enums$1.FontType.Default:
	            default:
	                return this.default;
	        }
	    };
	...
	hostConfig.FontTypeSet = FontTypeSet;
	var HostConfig$1 = /** @class */ (function () {
	    ...
	    HostConfig.prototype.getFontTypeDefinition = function (style) {
	        if (this.fontTypes) {
	            ...
	            return style == Enums$1.FontType.Monospace ? FontTypeDefinition.monospace : this._legacyFontType;
	        }
	    };
	    HostConfig.prototype.getEffectiveSpacing = function (spacing) {
	        switch (spacing) {
	            case Enums$1.Spacing.Small:
	                return this.spacing.small;
	            case Enums$1.Spacing.Default:
	                return this.spacing.default;
	            case Enums$1.Spacing.Medium:
	                return this.spacing.medium;
	            case Enums$1.Spacing.Large:
	                return this.spacing.large;
	            case Enums$1.Spacing.ExtraLarge:
	                return this.spacing.extraLarge;
	            case Enums$1.Spacing.Padding:
	    ...
	    HostConfig.prototype.paddingDefinitionToSpacingDefinition = function (paddingDefinition) {
	        return new Shared$1.SpacingDefinition(this.getEffectiveSpacing(paddingDefinition.top), this.getEffectiveSpacing(paddingDefinition.right), this.getEffectiveSpacing(paddingDefinition.bottom), this.getEffectiveSpacing(paddingDefinition.left));
	    };
	...
	hostConfig.HostConfig = HostConfig$1;
	...
	Object.defineProperty(textFormatters, "__esModule", { value: true });
	// Copyright (c) Microsoft Corporation. All rights reserved.
	// Licensed under the MIT License.
	...
	var DateFormatter = /** @class */ (function (_super) {
	    __extends$1(DateFormatter, _super);
	...
	var TimeFormatter = /** @class */ (function (_super) {
	    __extends$1(TimeFormatter, _super);
	...
	textFormatters.formatText = formatText;
	...
	Object.defineProperty(cardElements, "__esModule", { value: true });
	// Copyright (c) Microsoft Corporation. All rights reserved.
	// Licensed under the MIT License.
	var Enums = enums;
	var Shared = shared;
	...
	var TextFormatters = textFormatters;
	var dompurify_1 = require$$5;
	{
	    Config;
	}
	from;
	function sanitizeHTML(html, extendedConfig) {
	    if (extendedConfig === void 0) { extendedConfig = {}; }
	    return dompurify_1.sanitize(html, __assign({}, extendedConfig, { USE_PROFILES: { html: true }, RETURN_TRUSTED_TYPE: true }));
	}
	...
	cardElements.createActionInstance = createActionInstance;
	...
	cardElements.createElementInstance = createElementInstance;
	...
	cardElements.SerializableObject = SerializableObject;
	...
	cardElements.ValidationFailure = ValidationFailure;
	...
	cardElements.ValidationResults = ValidationResults;
	...
	cardElements.CardObject = CardObject;
	...
	cardElements.BaseTextBlock = BaseTextBlock;
	...
	cardElements.TextBlock = TextBlock;
	...
	cardElements.RichTextBlock = RichTextBlock;
	    ...
	    Image.prototype.internalRender = function () {
	        ...
	        if (!Utils.isNullOrEmpty(this.url)) {
	            ...
	            imageElement.onerror = function (e) {
	                ...
	                _this.renderedElement.innerHTML = sanitizeHTML("");
	...
	cardElements.CardElementContainer = CardElementContainer;
	...
	cardElements.ImageSet = ImageSet;
	...
	cardElements.MediaSource = MediaSource;
	...
	cardElements.InputValidationOptions = InputValidationOptions;
	...
	cardElements.TextInput = TextInput;
	...
	cardElements.ToggleInput = ToggleInput;
	...
	cardElements.ChoiceSetInput = ChoiceSetInput;
	...
	cardElements.NumberInput = NumberInput;
	...
	cardElements.DateInput = DateInput;
	...
	cardElements.TimeInput = TimeInput;
	...
	cardElements.SubmitAction = SubmitAction;
	...
	cardElements.OpenUrlAction = OpenUrlAction;
	...
	cardElements.ToggleVisibilityAction = ToggleVisibilityAction;
	...
	cardElements.HttpHeader = HttpHeader;
	...
	cardElements.HttpAction = HttpAction;
	...
	cardElements.ShowCardAction = ShowCardAction;
	...
	cardElements.ActionSet = ActionSet;
	...
	cardElements.StylableCardElementContainer = StylableCardElementContainer;
	...
	cardElements.BackgroundImage = BackgroundImage;
	...
	cardElements.Container = Container;
	...
	cardElements.ColumnSet = ColumnSet;
	...
	cardElements.ContainerWithActions = ContainerWithActions;
	...
	cardElements.TypeRegistry = TypeRegistry;
	...
	cardElements.ElementTypeRegistry = ElementTypeRegistry;
	...
	cardElements.ActionTypeRegistry = ActionTypeRegistry;
	...
	cardElements.AdaptiveCard = AdaptiveCard;
	...
	window.adaptiveCard = new adaptivecards.AdaptiveCard();
