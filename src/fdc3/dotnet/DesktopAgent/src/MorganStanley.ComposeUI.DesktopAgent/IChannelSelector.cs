...
namespace MorganStanley.ComposeUI.Fdc3.DesktopAgent
{
    public interface IChannelSelector
    {
        ...
        public Task SendChannelSelectorColorUpdateRequest(JoinUserChannelRequest req, string? color, CancellationToken cancellationToken = default);
       ...
       // public Task<ChannelSelectorResponse?> SendChannelSelectorColorUpdateRequest(JoinUserChannelRequest req, string? color, CancellationToken cancellationToken = default);
        ...
        //public Task<ChannelSelectorResponse?> SendChannelSelectorRequest(JoinUserChannelRequest req, string? color, CancellationToken cancellationToken = default);
    }
}
