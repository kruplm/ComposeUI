...
{
    internal class ChannelSelectorMessageRouterCommunicator : IChannelSelectorCommunicator
    {

        private readonly ILogger<ChannelSelectorMessageRouterCommunicator> _logger;
        ...
        public ChannelSelectorMessageRouterCommunicator(
            IMessageRouter messageRouter,
            ILogger<ChannelSelectorMessageRouterCommunicator>? logger = null)
        {
            _messageRouter = messageRouter;
            _logger = logger ?? NullLogger<ChannelSelectorMessageRouterCommunicator>.Instance;
        }
